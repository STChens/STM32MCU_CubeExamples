...
#define COM_UART_TX_GPIO_PORT                   GPIOE
#define COM_UART_TX_PIN                         GPIO_PIN_5
#define COM_UART_TX_GPIO_CLK_ENABLE()           __HAL_RCC_GPIOE_CLK_ENABLE()
#define COM_UART_TX_GPIO_CLK_DISABLE()          __HAL_RCC_GPIOE_CLK_DISABLE()

#define COM_UART_RX_AF                          GPIO_AF7_USART1
#define COM_UART_RX_GPIO_PORT                   GPIOE
#define COM_UART_RX_PIN                         GPIO_PIN_6
#define COM_UART_RX_GPIO_CLK_ENABLE()           __HAL_RCC_GPIOE_CLK_ENABLE()
#define COM_UART_RX_GPIO_CLK_DISABLE()          __HAL_RCC_GPIOE_CLK_DISABLE()
