...
const struct mpu_armv8m_region_cfg_t region_cfg_appli_s[] = {
  ...
  /* Region 1: Allows execution of appli */
  {
    ...
    FLASH_BASE_S + S_IMAGE_PRIMARY_PARTITION_OFFSET + FLASH_S_ACTIVESLOT_SIZE - 1 - (~MPU_RLAR_LIMIT_Msk +1),
    MPU_ARMV8M_MAIR_ATTR_DATA_IDX,
    MPU_ARMV8M_XN_EXEC_OK,
    MPU_ARMV8M_AP_RO_PRIV_ONLY,
    MPU_ARMV8M_SH_NONE,
  ...
  {
    2,
    FLASH_BASE_S + S_IMAGE_PRIMARY_PARTITION_OFFSET + FLASH_S_ACTIVESLOT_SIZE - (~MPU_RLAR_LIMIT_Msk +1),
    FLASH_BASE_S + S_IMAGE_PRIMARY_PARTITION_OFFSET + FLASH_S_ACTIVESLOT_SIZE - 1,
    MPU_ARMV8M_MAIR_ATTR_DATANOCACHE_IDX,
    MPU_ARMV8M_XN_EXEC_NEVER,
    MPU_ARMV8M_AP_RW_PRIV_ONLY,
    MPU_ARMV8M_SH_NONE,
