...
echo ===== Application selected through env_sonlyapp.bat:
...
echo ===== please modify the env_sonlyapp.bat to set the right path
goto step_error
)
...
echo        Select OEMiROT_Config.xml(Default path is \ROT_Provisioning\OEMiROT_SOnlyApp\Config\OEMiROT_Config.xml)
...
echo        Select OEMiRoT_S_Data_Image.xml(Default path is \ROT_Provisioning\OEMiROT_SOnlyApp\Images\OEMiROT_S_Data_Image.xml)
